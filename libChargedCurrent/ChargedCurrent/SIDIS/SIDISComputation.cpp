...
class SIDISComputation {
	...
	PerturbativeQuantity structure_function(
		...
		const auto &quark_to_quark_lo, const auto &&quark_to_gluon_lo, const auto &&gluon_to_quark_lo, 
		const auto &quark_to_quark_nlo, const auto &&quark_to_gluon_nlo, const auto &&gluon_to_quark_nlo, 
		const auto &quark_to_quark_nnlo, const auto &&quark_to_gluon_nnlo, const auto &&gluon_to_quark_nnlo, 
		...
		const double lo = SIDISFunctions::evaluate<PDFInterface, FFInterface>(
			{}, &params, quark_to_quark_lo, quark_to_gluon_lo, gluon_to_quark_lo, false, false, false, sign
		);

		double nlo = 0.0;
		if (order >= PerturbativeOrder::NLO) {
			Integrator nlo_integrator([=](double input[], [[maybe_unused]] std::size_t dim, void *params_in) {
				return SIDISFunctions::evaluate<PDFInterface, FFInterface>(
					input, params_in, quark_to_quark_nlo, quark_to_gluon_nlo, gluon_to_quark_nlo, true, true, false, sign
				);
		...
		if (order >= PerturbativeOrder::NNLO) {
			Integrator nnlo_integrator([=](double input[], [[maybe_unused]] std::size_t dim, void *params_in) {
				return SIDISFunctions::evaluate<PDFInterface, FFInterface>(
					input, params_in, quark_to_quark_nnlo, quark_to_gluon_nnlo, gluon_to_quark_nnlo, true, true, false, sign
				);
			}, {x, z}, {1, 1}, integration_parameters, &params);
	...
	PerturbativeQuantity F2(const double z, const TRFKinematics &kinematics) const {
		if (use_nlp_nlo) {
			return structure_function(
				z, kinematics, 
				SIDISFunctions::F2::LO::quark_to_quark, SIDISFunctions::F2::LO::quark_to_gluon, SIDISFunctions::F2::LO::gluon_to_quark,
				SIDISFunctions::F2::NLO_NLP::quark_to_quark, SIDISFunctions::F2::NLO_NLP::quark_to_gluon, SIDISFunctions::F2::NLO_NLP::gluon_to_quark,
				SIDISFunctions::F2::NNLO_NLP::quark_to_quark, SIDISFunctions::F2::NNLO_NLP::quark_to_gluon, SIDISFunctions::F2::NNLO_NLP::gluon_to_quark,
				1
			);
		} else {
			return structure_function(
				z, kinematics, 
				SIDISFunctions::F2::LO::quark_to_quark, SIDISFunctions::F2::LO::quark_to_gluon, SIDISFunctions::F2::LO::gluon_to_quark,
				SIDISFunctions::F2::NLO::quark_to_quark, SIDISFunctions::F2::NLO::quark_to_gluon, SIDISFunctions::F2::NLO::gluon_to_quark,
				SIDISFunctions::F2::NNLO_NLP::quark_to_quark, SIDISFunctions::F2::NNLO_NLP::quark_to_gluon, SIDISFunctions::F2::NNLO_NLP::gluon_to_quark,
				1
			);
		}
	...
	PerturbativeQuantity FL(const double z, const TRFKinematics &kinematics) const {
		if (use_nlp_nlo) {
			return structure_function(
				z, kinematics, 
				SIDISFunctions::FL::LO::quark_to_quark, SIDISFunctions::FL::LO::quark_to_gluon, SIDISFunctions::FL::LO::gluon_to_quark,
				SIDISFunctions::FL::NLO_NLP::quark_to_quark, SIDISFunctions::FL::NLO_NLP::quark_to_gluon, SIDISFunctions::FL::NLO_NLP::gluon_to_quark,
				SIDISFunctions::FL::NNLO_NLP::quark_to_quark, SIDISFunctions::FL::NNLO_NLP::quark_to_gluon, SIDISFunctions::FL::NNLO_NLP::gluon_to_quark,
				1
			);
		} else {
			return structure_function(
				z, kinematics, 
				SIDISFunctions::FL::LO::quark_to_quark, SIDISFunctions::FL::LO::quark_to_gluon, SIDISFunctions::FL::LO::gluon_to_quark,
				SIDISFunctions::FL::NLO::quark_to_quark, SIDISFunctions::FL::NLO::quark_to_gluon, SIDISFunctions::FL::NLO::gluon_to_quark,
				SIDISFunctions::FL::NNLO_NLP::quark_to_quark, SIDISFunctions::FL::NNLO_NLP::quark_to_gluon, SIDISFunctions::FL::NNLO_NLP::gluon_to_quark,
				1
			);
		}
	...
	PerturbativeQuantity F3(const double z, const TRFKinematics &kinematics) const {
		if (use_nlp_nlo) {
			return structure_function(
				z, kinematics, 
				SIDISFunctions::F3::LO::quark_to_quark, SIDISFunctions::F3::LO::quark_to_gluon, SIDISFunctions::F3::LO::gluon_to_quark,
				SIDISFunctions::F3::NLO_NLP::quark_to_quark, SIDISFunctions::F3::NLO_NLP::quark_to_gluon, SIDISFunctions::F3::NLO_NLP::gluon_to_quark,
				SIDISFunctions::F3::NNLO_NLP::quark_to_quark, SIDISFunctions::F3::NNLO_NLP::quark_to_gluon, SIDISFunctions::F3::NNLO_NLP::gluon_to_quark,
				1
			);
		} else {
			return structure_function(
				z, kinematics, 
				SIDISFunctions::F3::LO::quark_to_quark, SIDISFunctions::F3::LO::quark_to_gluon, SIDISFunctions::F3::LO::gluon_to_quark,
				SIDISFunctions::F3::NLO::quark_to_quark, SIDISFunctions::F3::NLO::quark_to_gluon, SIDISFunctions::F3::NLO::gluon_to_quark,
				SIDISFunctions::F3::NNLO_NLP::quark_to_quark, SIDISFunctions::F3::NNLO_NLP::quark_to_gluon, SIDISFunctions::F3::NNLO_NLP::gluon_to_quark,
				1
			);
		}
	...
	PerturbativeQuantity differential_cross_section_xQ2(const double z, const TRFKinematics &kinematics) const {
			...
			Integrator nlo_integrator([this](double input[], [[maybe_unused]] std::size_t dim, void *params_in) {
				if (use_nlp_nlo) {
					return SIDISFunctions::cross_section<PDFInterface, FFInterface, DecayFunction>(input, params_in, 
						F2::NLO_NLP::quark_to_quark, F2::NLO_NLP::quark_to_gluon, F2::NLO_NLP::gluon_to_quark, 
						FL::NLO_NLP::quark_to_quark, FL::NLO_NLP::quark_to_gluon, FL::NLO_NLP::gluon_to_quark, 
						F3::NLO_NLP::quark_to_quark, F3::NLO_NLP::quark_to_gluon, F3::NLO_NLP::gluon_to_quark, 
						true, true, false
					);
				} else {
					return SIDISFunctions::cross_section<PDFInterface, FFInterface, DecayFunction>(input, params_in, 
		...
		if (order >= PerturbativeOrder::NNLO) {
			Integrator nnlo_integrator([](double input[], [[maybe_unused]] std::size_t dim, void *params_in) {
				return SIDISFunctions::cross_section<PDFInterface, FFInterface, DecayFunction>(input, params_in, 
					F2::NNLO_NLP::quark_to_quark, F2::NNLO_NLP::quark_to_gluon, F2::NNLO_NLP::gluon_to_quark, 
					FL::NNLO_NLP::quark_to_quark, FL::NNLO_NLP::quark_to_gluon, FL::NNLO_NLP::gluon_to_quark, 
					F3::NNLO_NLP::quark_to_quark, F3::NNLO_NLP::quark_to_gluon, F3::NNLO_NLP::gluon_to_quark, 
					true, true, false
				);
			}, {x, z}, {1, 1}, integration_parameters, &params);
			const auto nnlo_result = nnlo_integrator.integrate();
	...
	PerturbativeQuantity lepton_pair_cross_section_zxQ2(const TRFKinematics &kinematics, const double z) const {
		...
		if (order >= PerturbativeOrder::NLO) {
			Integrator nlo_integrator([&](double input[], [[maybe_unused]] std::size_t dim, void *params_in) {
				...
				const double value = use_nlp_nlo ? SIDISFunctions::cross_section<PDFInterface, FFInterface, DecayFunction>(total_input, params_in, 
					F2::NLO_NLP::quark_to_quark, F2::NLO_NLP::quark_to_gluon, F2::NLO_NLP::gluon_to_quark, 
					FL::NLO_NLP::quark_to_quark, FL::NLO_NLP::quark_to_gluon, FL::NLO_NLP::gluon_to_quark, 
					F3::NLO_NLP::quark_to_quark, F3::NLO_NLP::quark_to_gluon, F3::NLO_NLP::gluon_to_quark, 
					true, true, true
				) : SIDISFunctions::cross_section<PDFInterface, FFInterface, DecayFunction>(total_input, params_in, 
					F2::NLO::quark_to_quark, F2::NLO::quark_to_gluon, F2::NLO::gluon_to_quark, 
					FL::NLO::quark_to_quark, FL::NLO::quark_to_gluon, FL::NLO::gluon_to_quark, 
					F3::NLO::quark_to_quark, F3::NLO::quark_to_gluon, F3::NLO::gluon_to_quark, 
					true, true, true
	...
	PerturbativeQuantity x_integrated_lepton_pair_cross_section(const TRFKinematics &placeholder_kinematics, const double Q2) const {
		...
		const auto nlo_integrand = [&](double input[]) {
			...
			const double differential_cross_section = use_nlp_nlo ? SIDISFunctions::cross_section<PDFInterface, FFInterface, DecayFunction>(input, &params, 
				F2::NLO_NLP::quark_to_quark, F2::NLO_NLP::quark_to_gluon, F2::NLO_NLP::gluon_to_quark,
				FL::NLO_NLP::quark_to_quark, FL::NLO_NLP::quark_to_gluon, FL::NLO_NLP::gluon_to_quark,
				F3::NLO_NLP::quark_to_quark, F3::NLO_NLP::quark_to_gluon, F3::NLO_NLP::gluon_to_quark,
				true, true, true
			) : SIDISFunctions::cross_section<PDFInterface, FFInterface, DecayFunction>(input, &params, 
				F2::NLO::quark_to_quark, F2::NLO::quark_to_gluon, F2::NLO::gluon_to_quark,
				FL::NLO::quark_to_quark, FL::NLO::quark_to_gluon, FL::NLO::gluon_to_quark,
				F3::NLO::quark_to_quark, F3::NLO::quark_to_gluon, F3::NLO::gluon_to_quark,
				true, true, true
