...
// 	InterpolatingFunction(const std::filesystem::path grid_path, const std::string separator = "-----") : grid_path(grid_path) {
...
// 		std::vector<double> grid(line_count);
...
// 				}
// 				grid_points.push_back(points);
// 				dimensions.push_back(points.size());
// 			} else {
...
// 			dimension_conversions.push_back(value);
// 		}
// 	}
...
// 	std::vector<std::size_t> dimension_conversions;
