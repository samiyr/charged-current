...
namespace SIDISFunctions::NearThreshold {
	...
	static constexpr double D(const std::size_t n, const double x, const double xi, const double xq, const double xq_hat) {
	...
	static constexpr double l(const std::size_t n, const double xi, const double xq_hat) {
